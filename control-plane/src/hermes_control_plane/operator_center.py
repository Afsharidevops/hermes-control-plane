...
GROUPS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "surfaces": [
            ...
            _surface("cluster-factory.images-artifacts", "Images / Artifacts", "CONTRACT_ONLY", "artifact mirror inventory", "Digest-pinned inventory exists; synchronization runtime remains release-blocking."),
        ],
    },
    {
        "id": "infrastructure",
    ...
    },
    {
        ...
        "surfaces": [
            ...
            _surface("governance.artifact-mirror", "Artifact Mirror", "CONTRACT_ONLY", "artifact inventory/plan contract", "Inventory UI exists; mirror/sync executor remains release-blocking."),
