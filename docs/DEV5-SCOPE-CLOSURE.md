...
This is still partial disaster-recovery closure. Direct etcd snapshot/restore, full-cluster restore semantics, Velero schedules, provider-specific DR, control-plane recovery and post-provider recovery orchestration remain release-blocking.
