...
- remaining air-gap protocol closure: Helm OCI publication, OS/Python/package-repository metadata sync, broader signature policy and generalized authenticated repository credential delivery
