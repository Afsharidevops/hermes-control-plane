...
Hermes now also supports ChangeSet-governed exact-commit Argo CD sync, pinned Cilium Helm upgrades, and bounded one-shot Velero Backup creation through the trusted Kubernetes Broker, all with precondition-drift rejection and active verification. Velero schedules/restores, etcd snapshot/restore and broader provider/provisioner lifecycle remain in progress.
