...
for marker in ["HERMES_BOT_SERVICE_TOKEN", "HERMES_APPROVAL_BOT_TOKEN", "HERMES_APPROVAL_HMAC_KEY"]:
...
for marker in ["bot-service-token", "approval-bot-token", "approval-hmac-key"]:
