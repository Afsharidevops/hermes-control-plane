...
GROUPS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "surfaces": [
            ...
            _surface("operations.backups", "Backups", "PARTIAL", "BackupPlan + trusted Velero backup/restore runtime", "One-shot Velero Backup and bounded namespace Restore execution are ChangeSet-governed and actively verified; schedules, direct etcd recovery and provider-specific backup paths remain open."),
